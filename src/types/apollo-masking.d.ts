...
//
// Required because codegen.ts uses `inlineFragmentTypes: 'mask'` +
// `customDirectives.apolloUnmask: true`. Without this declaration merging,
// FragmentType<X> resolves to `never` (the PreserveTypes default).
//
