...
import type {
  ...
  HomeDisplayFragment,
  MemberShipFragment,
} from './homeFragments.generated';
import type { InviteCard_InviteFragment } from '../../../screens/onBoarding/createHome/CreateHomeScreen.generated';
...
export type GetMyPendingInvitesQuery = {
  ...
  me: {
    ...
    pendingHomeInvites: Array<
      { __typename: 'HomeInvite' } & InviteCard_InviteFragment
    >;
  } | null;
};
...
export type HomeInviteChangedSubscription = {
  ...
  homeInviteChanged: {
    ...
    userId: string;
    timestamp: string;
    homeInvite: { __typename: 'HomeInvite' } & InviteCard_InviteFragment;
  };
};
...
} as unknown as DocumentNode<GetHomesQuery, GetHomesQueryVariables>;
...
} as unknown as DocumentNode<CreateHomeMutation, CreateHomeMutationVariables>;
...
} as unknown as DocumentNode<UpdateHomeMutation, UpdateHomeMutationVariables>;
...
} as unknown as DocumentNode<DeleteHomeMutation, DeleteHomeMutationVariables>;
...
} as unknown as DocumentNode<LeaveHomeMutation, LeaveHomeMutationVariables>;
