...
export type MarkNotificationAsReadMutation = { __typename: 'Mutation', markNotificationAsRead: { __typename: 'NotificationPayload', success: boolean, message: string, code: string, notification: { __typename: 'Notification', id: string, status: Types.NotificationStatus } | null } };
...
export type MarkNotificationUnreadMutation = { __typename: 'Mutation', markNotificationUnread: { __typename: 'NotificationPayload', success: boolean, message: string, code: string, notification: { __typename: 'Notification', id: string, status: Types.NotificationStatus } | null } };
