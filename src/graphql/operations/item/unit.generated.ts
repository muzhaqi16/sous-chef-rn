...
export const GetUnitBySymbolDocument = /*#__PURE__*/ {
  kind: 'Document',
  definitions: [
    {
...
export type GetUnitBySymbolQueryResult = ApolloReactCommon.QueryResult<
  ...
  GetUnitBySymbolQueryVariables
>;
export const SearchUnitsDocument = /*#__PURE__*/ {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
...
export function useSearchUnitsQuery(
  ...
  > &
    (
      | { variables: SearchUnitsQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export type SearchUnitsQueryResult = ApolloReactCommon.QueryResult<
  ...
  SearchUnitsQueryVariables
>;
export const GetCommonUnitsDocument = /*#__PURE__*/ {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
