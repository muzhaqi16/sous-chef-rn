...
} as unknown as DocumentNode<ItemCoreFragment, unknown>;
...
} as unknown as DocumentNode<ItemDisplayFragment, unknown>;
          ...
          },
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'usageContext' },
                },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'recommendedFor' },
                },
                { kind: 'Field', name: { kind: 'Name', value: 'minQuantity' } },
                { kind: 'Field', name: { kind: 'Name', value: 'maxQuantity' } },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'quantityStep' },
                },
                {
                  kind: 'Field',
