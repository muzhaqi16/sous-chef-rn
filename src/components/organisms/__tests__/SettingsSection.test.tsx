...
describe('SettingsSection', () => {
  const defaultItems = [
    { key: 'theme', label: 'Theme', type: 'navigation' as const, onPress: jest.fn() },
    { key: 'language', label: 'Language', type: 'navigation' as const, onPress: jest.fn() },
    { key: 'notifications', label: 'Notifications', type: 'toggle' as const, value: true, onToggle: jest.fn() },
  ];
  ...
  it('renders a single item as both first and last', () => {
    const singleItem = [{ key: 'about', label: 'About', type: 'navigation' as const, onPress: jest.fn() }];
