...
const CHECK_ENTERING = FadeIn.duration(motion.timing.STANDARD).easing(
  motion.easing.standard.factory(),
);
const CHECK_EXITING = FadeOut.duration(motion.timing.FAST).easing(
  motion.easing.standard.factory(),
);
