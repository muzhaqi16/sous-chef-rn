...
export interface HeaderAction {
  ...
  loading?: boolean;
  /**
   * REQUIRED, like `SwipeAction.labelKey`: a header action is an icon with no
   * text, so nothing else can name it and a screen reader announces a bare
   * "button". Optional here is how four of them shipped unnamed.
   */
