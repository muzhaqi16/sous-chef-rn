...
export function useMealPlanActions() {
  ...
  const createMealPlan = async (input: CreateMealPlanInput) => {
    ...
    const outcome = !result
      ? 'rejected'
      : classifyCreateResult(result, 'createMealPlan', 'CreateMealPlanPayload');
  ...
  const updateMealPlan = async (
    ...
    const outcome = !result
      ? 'rejected'
      : classifyCreateResult(result, 'updateMealPlan', 'UpdateMealPlanPayload');
  ...
  const deleteMealPlan = async (id: string) => {
    ...
    const outcome = !result
      ? 'rejected'
      : classifyCreateResult(result, 'deleteMealPlan', 'DeleteMealPlanPayload');
