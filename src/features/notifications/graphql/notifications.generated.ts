...
export type NotificationChangedSubscriptionVariables = Types.Exact<{ [key: string]: never; }>;


export type NotificationChangedSubscription = { __typename: 'Subscription', notificationChanged: { __typename: 'NotificationChangeEvent', changeType: Types.NotificationChangeType, timestamp: string, notification: (
      { __typename: 'Notification' }
      & NotificationFragment
    ) } };

export type GetUnreadNotificationsQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type GetUnreadNotificationsQuery = { __typename: 'Query', me: { __typename: 'User', id: string, notificationsConnection: { __typename: 'NotificationConnection', edges: Array<{ __typename: 'NotificationEdge', node: (
          { __typename: 'Notification' }
          & NotificationFragment
 ...
 * });
 */
export function useGetUnreadNotificationsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetUnreadNotificationsQuery, GetUnreadNotificationsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<GetUnreadNotificationsQuery, GetUnreadNotificationsQueryVariables>(GetUnreadNotificationsDocument, options);
      }
export function useGetUnreadNotificationsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetUnreadNotificationsQuery, GetUnreadNotificationsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<GetUnreadNotificationsQuery, GetUnreadNotificationsQueryVariables>(GetUnreadNotificationsDocument, options);
        }
// @ts-ignore
export function useGetUnreadNotificationsSuspenseQuery(baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<GetUnreadNotificationsQuery, GetUnreadNotificationsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetUnreadNotificationsQuery, GetUnreadNotificationsQueryVariables>;
export function useGetUnreadNotificationsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetUnreadNotificationsQuery, GetUnreadNotificationsQueryVariables>): ApolloReactHooks.UseSuspenseQueryResult<GetUnreadNotificationsQuery | undefined, GetUnreadNotificationsQueryVariables>;
export function useGetUnreadNotificationsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetUnreadNotificationsQuery, GetUnreadNotificationsQueryVariables>) {
          const options = baseOptions === ApolloReactHooks.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useSuspenseQuery<GetUnreadNotificationsQuery, GetUnreadNotificationsQueryVariables>(GetUnreadNotificationsDocument, options);
        }
...
export type GetUnreadNotificationsSuspenseQueryHookResult = ReturnType<typeof useGetUnreadNotificationsSuspenseQuery>;
export type GetUnreadNotificationsQueryResult = ApolloReactCommon.QueryResult<GetUnreadNotificationsQuery, GetUnreadNotificationsQueryVariables>;