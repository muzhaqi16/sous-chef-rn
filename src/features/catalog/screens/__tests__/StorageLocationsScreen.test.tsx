...
import type { StorageLocationCard as StorageLocationCardComponent } from '#features/catalog/ui/StorageLocationCard';
import { StorageLocationsScreen } from '#features/catalog/screens/StorageLocationsScreen';
...
jest.mock('#features/catalog/hooks/useStorageLocationManagement', () => ({
...
jest.mock('#features/catalog/ui/StorageLocationCard', () => ({
  StorageLocationCard: ({
    location,
    onDelete,
...
jest.mock(
  '#features/catalog/ui/StorageLocationSheet/StorageLocationSheet',
  () => ({
...
describe('StorageLocationsScreen', () => {
  ...
  it('shows loading state when initial loading', () => {
    const { useStorageLocationManagement } = jest.requireMock(
      '#features/catalog/hooks/useStorageLocationManagement',
    );
